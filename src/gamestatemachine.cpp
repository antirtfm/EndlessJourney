...
constexpr std::array transitions {
    ...
    Transition { State::Playing, Event::TogglePause, State::Paused },
    Transition { State::Paused, Event::TogglePause, State::Playing },
    ...
    Transition { State::Paused, Event::ReturnToMenu, State::Menu },
